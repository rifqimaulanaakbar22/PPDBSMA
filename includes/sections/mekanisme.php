            ...
            <div class="col-lg-7">
                <div class="p-5 bg-gov-light rounded-4 text-center border">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="<?php echo BASE_URL; ?>user/login.php" class="btn btn-primary px-4 py-2 rounded-pill shadow-sm">Masuk Akun</a>
                        <a href="<?php echo BASE_URL; ?>user/login.php?action=register" class="btn btn-outline-primary px-4 py-2 rounded-pill">Registrasi</a>
                    </div>
                </div>
            </div>
        </div>
