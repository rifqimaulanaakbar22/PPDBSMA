    ...
    <div class="card h-100 directory-card border-0 shadow-sm overflow-hidden animate-fade-in">
        ...
        <div class="position-relative">
            <?php if (!empty($sekolah['foto']) && file_exists(ROOT_PATH . 'public/uploads/sekolah/' . $sekolah['foto'])): ?>
                <img src="<?php echo url('uploads/sekolah/' . htmlspecialchars($sekolah['foto'])); ?>" 
                     ...
                     class="directory-img w-100" style="height: 400px; object-fit: cover;">
            <?php else: ?>
        ...
        <div class="card-body p-4">
            ...
            <div class="pt-3 border-top d-flex align-items-center justify-content-between">
                ...
                <!-- Updated link to use route -->
                <a href="<?php echo url('kuota/' . $sekolah['id']); ?>" class="btn btn-primary btn-sm rounded-pill px-4 fw-bold">
                    Lihat Detail
                </a>
            </div>
        </div>
