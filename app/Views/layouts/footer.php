        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo asset('images/logo_kemdikbud.png'); ?>" alt="Logo" width="50" height="50" class="me-3 bg-white rounded-circle p-1">
                        <div>
                ...
                <div class="col-md-4 col-lg-2">
                    ...
                    <ul class="list-unstyled small opacity-75">
                        ...
                        <li class="mb-2"><a href="<?php echo url('kuota'); ?>" class="text-black text-decoration-none">Daya Tampung</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <ul class="list-unstyled small opacity-75">
                        <li class="mb-3 d-flex">
                            ...
                            <span>Jl. Jenderal Sudirman No.1, Padang Pasir, Kec. Padang Bar., Kota Padang, Sumatera Barat</span>
                        </li>
                        <li class="mb-3 d-flex">
                            <i class="bi bi-envelope me-2"></i>
                            <span>ppdb@padang.go.id</span>
                        </li>
                        <li class="mb-3 d-flex">
                            <i class="bi bi-whatsapp me-2"></i>
                            <span>+62 812-3456-7890 (Helpdesk)</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start">
                    <p class="small opacity-75 mb-0">&copy; 2025 Copyright : Diskominfotik - Aplikasi SPMB Online v1.1.0</p>
                </div>
                <div class="col-md-6 text-center text-md-end mt-3 mt-md-0">
                    <p class="small mb-0">Made with <i class="bi bi-heart-fill text-danger mx-1"></i> for Padang</p>
                </div>
            </div>
        </div>
    </footer>
