            ...
            <div class="col-lg-7">
                <div class="d-flex align-items-center mb-4">
                    <div class="bg-white p-2 rounded-circle me-3 shadow-lg">
                        <img src="<?php echo asset('images/logo_kemdikbud.png'); ?>" alt="Logo" width="50" height="50">
                    </div>
                    <div>
                ...
                <p class="lead opacity-75 mb-4">
                    Sistem Penerimaan Peserta Didik Baru (PPDB) SMA Negeri Kota Padang Online
                </p>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="bg-white bg-opacity-10 p-3 rounded-3 text-center">
                                <h3 class="fw-bold mb-0"><?php echo isset($stats['total_sekolah']) ? $stats['total_sekolah'] : count($sekolah_list); ?></h3>
                                <small class="opacity-75">Sekolah</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="bg-white bg-opacity-10 p-3 rounded-3 text-center">
                                <h3 class="fw-bold mb-0"><?php echo isset($stats['total_kuota']) ? number_format($stats['total_kuota']) : 0; ?></h3>
